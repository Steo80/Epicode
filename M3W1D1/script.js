        ...
        /* EXTRA Crea con JavaScript la funzionalità per creare un alert col nome dell'autore ogni volta che il cursore passa sopra l'autore del 
           post.*/


const twitterRemove =document.querySelector('div .p-4:nth-of-type(3) li:nth-of-type(2)')
    twitterRemove.remove();
